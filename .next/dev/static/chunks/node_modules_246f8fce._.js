...
"[project]/node_modules/@web3forms/react/dist/index.modern.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const __TURBOPACK__default__export__ = ({ access_key: e, settings: s = {}, onSuccess: t, onError: n })=>({
        submit: function(o) {
            try {
                return Promise.resolve(fetch("https://api.web3forms.com/submit", {
                    method: "POST",
                    headers: {
                    ...
                    return Promise.resolve(e.json()).then(function(e) {
                        !0 === e.success ? t(e.message, e) : n(e.message, e);
                    });
                });
            } catch (e) {
...
//# sourceMappingURL=node_modules_246f8fce._.js.map